  ...
  async function handleDownloadPDF(
    ...
    if (tplConfig.generator === "vedant") {
      ...
      blob = await generateAKEnterprisePdf({
        ...
        clientName,
        clientBranch,
        clientGstin: (mode === "invoice" || mode === "credit_note") ? (clientGstin || undefined) : undefined,
        subject,
        items: printItems,
        total: subtotal,
        notes: (mode === "invoice" || mode === "credit_note") ? terms : undefined,
        showTotal,
        terms: (mode === "quotation" || mode === "sales_order" || mode === "delivery_challan" || mode === "eway_bill") ? terms : undefined,
        accountInfo: (mode === "invoice" || mode === "credit_note") ? acct : undefined,
        headerImageUrl: (mode === "quotation" || mode === "sales_order" || mode === "delivery_challan" || mode === "eway_bill") ? hdr : undefined,
        signatureImageUrl: sig,
